...
void LayoutDocument::buildDemoShapes()
{
	...
	objmat1->background_color = vec4i(200, 0, 0, 255);
	...
	objmat2->background_color = vec4i(200, 200, 0, 255);
	...
	objmat3->background_color = vec4i(0, 0, 200, 255);
	...
	objmat4->background_color = vec4i(200, 0, 200, 255);
...
void LayoutDocument::saveShapeFile ( const char* filename, const char* slcFileName )
{
		...
		pp!=shapesInfo.end(); ++pp )
	{
		...
		for ( int i=0; i<sinfo.primitiveCount; i++ )
		{
			if ( sinfo.node == NULL )
				continue;

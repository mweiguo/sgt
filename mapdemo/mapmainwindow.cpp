...
void MapMainWindow::init ()
{
    doc->init ( displayer->widget, shareWidget );
}

void MapMainWindow::open()
{
    try
    {
...
void MapMainWindow::open ( const char* filename )
{
...
void MapMainWindow::actionEvent( QAction* action )
{
    try
    {
...
void MapMainWindow::onMainViewTransformChanged(float x1, float y1, float x2, float y2 )
{
    try
    {
//	cout << "-----------------MapMainWindow::onMainViewTransformChanged" << endl;
...
void MapMainWindow::createActions()
{
...
void MapMainWindow::createMenus()
{
...
void MapMainWindow::createToolBars()
{
...
void MapMainWindow::createStatusBar()
{

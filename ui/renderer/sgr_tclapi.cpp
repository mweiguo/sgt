...
int tcl_camera_create ( ClientData /*clientData*/, Tcl_Interp* interp, int objc, Tcl_Obj* const objv[] )
{
    ...
    {
        if ( objc != 3 ) {
            Tcl_WrongNumArgs ( interp, 0, objv, "camera_create id cameraname" );
            return TCL_ERROR;
        }
...
int tcl_viewport_create ( ClientData /*clientData*/, Tcl_Interp* interp, int objc, Tcl_Obj* const objv[] )
{
    ...
    {
        if ( objc != 3 ) {
            Tcl_WrongNumArgs ( interp, 0, objv, "viewport_create id name" );
            return TCL_ERROR;
        }

        int len, id;
        Tcl_GetIntFromObj ( interp, objv[1], &id );
        const char* vpname = Tcl_GetStringFromObj ( objv[2], &len );
        viewport_create ( id, vpname );
...
int tcl_node_save ( ClientData /*clientData*/, Tcl_Interp* interp, int objc, Tcl_Obj* const objv[] )
{
    ...
    {
        if ( objc != 3 ) {
            Tcl_WrongNumArgs ( interp, 0, objv, "node_save file meshid" );
            return TCL_ERROR;
        }
...
int tcl_color_create ( ClientData /*clientData*/, Tcl_Interp* interp, int objc, Tcl_Obj* const objv[] )
{
    ...
    {
        if ( objc != 3 ) {
            Tcl_WrongNumArgs ( interp, 0, objv, "color_create id color" );
            return TCL_ERROR;
        }
...
int tcl_attrset_create ( ClientData /*clientData*/, Tcl_Interp* interp, int objc, Tcl_Obj* const objv[] )
{
    ...
    {
        if ( objc != 3 ) {
            Tcl_WrongNumArgs ( interp, 0, objv, "attrset_create id layerid" );
            return TCL_ERROR;
        }

        int layerid, id;
        Tcl_GetIntFromObj ( interp, objv[1], &id );
        Tcl_GetIntFromObj ( interp, objv[2], &layerid );
        attrset_create ( id, layerid );
        Tcl_Obj* rstobj = Tcl_NewIntObj(id);
        Tcl_SetObjResult ( interp, rstobj );
        return TCL_OK;
    } catch ( std::exception& e ) {
...
int tcl_scene_create ( ClientData /*clientData*/, Tcl_Interp* interp, int objc, Tcl_Obj* const objv[] )
{
    ...
    {
        if ( objc != 2 ) {
            Tcl_WrongNumArgs ( interp, 0, objv, "scene_create id" );
            return TCL_ERROR;
        }
...
int tcl_layer_create ( ClientData /*clientData*/, Tcl_Interp* interp, int objc, Tcl_Obj* const objv[] )
{
    ...
    {
        if ( objc != 3 ) {
            Tcl_WrongNumArgs ( interp, 0, objv, "layer_create id name" );
            return TCL_ERROR;
        }
...
int tcl_lod_create ( ClientData /*clientData*/, Tcl_Interp* interp, int objc, Tcl_Obj* const objv[] )
{
    ...
    {
        if ( objc != 2 ) {
            Tcl_WrongNumArgs ( interp, 0, objv, "lod_create id" ); 
            return TCL_ERROR;
        }
...
int tcl_kdtree_create ( ClientData /*clientData*/, Tcl_Interp* interp, int objc, Tcl_Obj* const objv[] )
{
    ...
    {
        if ( objc != 2 ) {
            Tcl_WrongNumArgs ( interp, 0, objv, "kdtree_create id" );
            return TCL_ERROR;
        }
...
int tcl_array_create ( ClientData /*clientData*/, Tcl_Interp* interp, int objc, Tcl_Obj* const objv[] )
{
    ...
    {
        if ( objc != 2 ) {
            Tcl_WrongNumArgs ( interp, 0, objv, "array_create id" ); 
            return TCL_ERROR;
        }
...
int tcl_rectangle_create ( ClientData /*clientData*/, Tcl_Interp* interp, int objc, Tcl_Obj* const objv[] )
{
    ...
    {
        if ( objc != 2 ) {
            Tcl_WrongNumArgs ( interp, 0, objv, "rectangle_create id" ); 
            return TCL_ERROR;
        }
...
int tcl_transform_create ( ClientData /*clientData*/, Tcl_Interp* interp, int objc, Tcl_Obj* const objv[] )
{
    ...
    {
        if ( objc != 2 ) {
            Tcl_WrongNumArgs ( interp, 0, objv, "transform_create id" ); 
            return TCL_ERROR;
        }
...
int tcl_pickablegroup_create ( ClientData /*clientData*/, Tcl_Interp* interp, int objc, Tcl_Obj* const objv[] )
{
    ...
    {
        if ( objc != 2 ) {
            Tcl_WrongNumArgs ( interp, 0, objv, "pickablegroup_create id" ); 
            return TCL_ERROR;
        }
...
int tcl_switchnode_create ( ClientData /*clientData*/, Tcl_Interp* interp, int objc, Tcl_Obj* const objv[] )
{
    ...
    {
        if ( objc != 2 ) {
            Tcl_WrongNumArgs ( interp, 0, objv, "switchnode_create id" ); 
            return TCL_ERROR;
        }
...
int tcl_switchnode_selection ( ClientData /*clientData*/, Tcl_Interp* interp, int objc, Tcl_Obj* const objv[] )
{
    ...
    {
        if ( objc != 3 ) {
            Tcl_WrongNumArgs ( interp, 0, objv, "switchnode_selection id idx" ); 
            return TCL_ERROR;
        }
...
int tcl_groupnode_create ( ClientData /*clientData*/, Tcl_Interp* interp, int objc, Tcl_Obj* const objv[] )
{
    ...
    {
        if ( objc != 2 && objc != 3 ) {
            Tcl_WrongNumArgs ( interp, 0, objv, "groupnode_create id name" ); 
            return TCL_ERROR;
        }
...
int tcl_text_create ( ClientData /*clientData*/, Tcl_Interp* interp, int objc, Tcl_Obj* const objv[] )
{
    ...
    {
        if ( objc > 3 || objc < 1 ) {
            Tcl_WrongNumArgs ( interp, 0, objv, "text_create id text" ); 
            return TCL_ERROR;
        }
...
int tcl_font_create ( ClientData /*clientData*/, Tcl_Interp* interp, int objc, Tcl_Obj* const objv[] )
{
    ...
    {
        if ( objc != 2 ) {
            Tcl_WrongNumArgs ( interp, 0, objv, "font_create id" ); 
            return TCL_ERROR;
        }
...
int tcl_line_create ( ClientData /*clientData*/, Tcl_Interp* interp, int objc, Tcl_Obj* const objv[] )
{
    ...
    {
        if ( objc != 2 ) {
            Tcl_WrongNumArgs ( interp, 0, objv, "line_create id" ); 
            return TCL_ERROR;
        }
...
int tcl_polyline_create ( ClientData /*clientData*/, Tcl_Interp* interp, int objc, Tcl_Obj* const objv[] )
{
    ...
    {
        if ( objc != 2 ) {
            Tcl_WrongNumArgs ( interp, 0, objv, "polyline_create id" ); 
            return TCL_ERROR;
        }
...
int tcl_polyline_points ( ClientData /*clientData*/, Tcl_Interp* interp, int objc, Tcl_Obj* const objv[] )
{
    ...
    {
        if ( objc < 6 || objc%2!=0 ) {
            Tcl_WrongNumArgs ( interp, 0, objv, "polyline_points id xycoords..." );
            return TCL_ERROR;
        }

        float* data = new float[objc-2];
        ...
        int id;
        Tcl_GetIntFromObj ( interp, objv[1], &id ); 
        polyline_points ( id, data, (objc-2)/2 );
        delete[] data;
...
int tcl_poly_create ( ClientData /*clientData*/, Tcl_Interp* interp, int objc, Tcl_Obj* const objv[] )
{
    ...
    {
        if ( objc != 2 ) {
            Tcl_WrongNumArgs ( interp, 0, objv, "poly_create id" ); 
            return TCL_ERROR;
        }
...
int tcl_poly_points ( ClientData /*clientData*/, Tcl_Interp* interp, int objc, Tcl_Obj* const objv[] )
{
    ...
    {
        if ( objc < 6 || objc%2!=0 ) {
            Tcl_WrongNumArgs ( interp, 0, objv, "poly_points id xycoords..." );
            return TCL_ERROR;
        }
...
int tcl_point_create ( ClientData /*clientData*/, Tcl_Interp* interp, int objc, Tcl_Obj* const objv[] )
{
    ...
    {
        if ( objc != 2 ) {
            Tcl_WrongNumArgs ( interp, 0, objv, "point_create id" ); 
            return TCL_ERROR;
        }
...
int tcl_point_coord ( ClientData /*clientData*/, Tcl_Interp* interp, int objc, Tcl_Obj* const objv[] )
{
    ...
    {
        if ( objc != 6 ) {
            Tcl_WrongNumArgs ( interp, 0, objv, "point_coord id x y" );
            return TCL_ERROR;
        }
...
int tcl_point_size ( ClientData /*clientData*/, Tcl_Interp* interp, int objc, Tcl_Obj* const objv[] )
{
    ...
    {
        if ( objc != 6 ) {
            Tcl_WrongNumArgs ( interp, 0, objv, "point_size id sz" );
            return TCL_ERROR;
        }
        ...
        double sz;
        Tcl_GetIntFromObj ( interp, objv[1], &id ); 
        Tcl_GetDoubleFromObj ( interp, objv[2], &sz ); 
...
void register_tclcmds ( Tcl_Interp* interp )
{
    ...
    Tcl_CreateObjCommand ( interp, "scene_save",            tcl_node_save               ,0 ,0 );
...
//     Tcl_CreateObjCommand ( interp, "pick_volume",           tcl_pick_volume             ,0 ,0 );
    ...
    Tcl_CreateObjCommand ( interp, "switchnode_selection",  tcl_switchnode_props       	,0 ,0 );
    ...
    Tcl_CreateObjCommand ( interp, "polyline_create",       tcl_polyline_create         ,0 ,0 );               
    Tcl_CreateObjCommand ( interp, "polyline_points",       tcl_polyline_points         ,0 ,0 );               
    Tcl_CreateObjCommand ( interp, "poly_create",           tcl_poly_create             ,0 ,0 );               
    Tcl_CreateObjCommand ( interp, "poly_points",           tcl_poly_points             ,0 ,0 );               
}
